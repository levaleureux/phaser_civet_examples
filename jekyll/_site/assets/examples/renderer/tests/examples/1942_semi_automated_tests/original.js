...
function testCollision ()
{
    ...
    assert('Setting stop  tile.collides).length === 0
    );
...
function testManipulatingTiles()
{
    ...
    map.randomize();
    var incorrectIndexes = map.filterTiles(t => t.index  16);
    ...
    var incorrectIndexes = map.filterTiles(t => t.index  19);
    ...
    var incorrectIndexes = map.filterTiles(t => t.index  3);
